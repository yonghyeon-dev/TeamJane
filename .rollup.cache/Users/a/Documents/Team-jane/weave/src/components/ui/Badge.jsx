...
const Badge = React.forwardRef(({ variant = "primary", size = "md", children, className }, ref) => {
    ...
    return (<div ref={ref} className={cn("inline-flex items-center rounded-md font-medium", variants[variant], sizes[size], className)} style={getDynamicStyles()}>
        {children}
      </div>);
});
