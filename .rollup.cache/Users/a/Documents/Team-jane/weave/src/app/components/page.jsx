...
import { Button, Card, CardImage, CardHeader, CardTitle, CardDescription, CardContent, CardFooter, Status, Typography, Input, Badge, Avatar, Carousel, CarouselItem, Navbar, Footer, Hero, ThemeSelector, ColorSelector, } from "@/components/ui";
    ...
    return (<ThemeWrapper>
      <div className="min-h-screen bg-primary-background text-text-primary font-primary">
        ...
        <section className="mb-16">
          <Typography variant="h2" size="2xl" weight="semibold" className="mb-8 text-center">
        ...
        <section className="mb-16">
          ...
          <div className="space-y-16">
            ...
            <Card variant="elevated">
              ...
              <CardContent>
                <div className="border border-primary-borderSecondary rounded-lg overflow-hidden">
                  <Hero title="Build something amazing" subtitle="Welcome to Weave" description="Create beautiful, responsive websites with our powerful design system. Start building your next project today with confidence." primaryAction={{
            label: "Get Started",
            href: "#",
            variant: "primary",
        }} secondaryAction={{
            ...
            href: "#",
            variant: "secondary",
        }} image="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=600&fit=crop" imageAlt="Design workspace"/>
                </div>
              </CardContent>
            </Card>
            ...
            <Card variant="elevated">
              ...
              <CardContent>
                <div className="border border-primary-borderSecondary rounded-lg overflow-hidden">
                  <Hero variant="centered" title="Transform your workflow" subtitle="Powerful Design Tools" description="Streamline your design process with our comprehensive toolkit. Collaborate seamlessly with your team." primaryAction={{
            ...
            <Card variant="elevated">
              ...
              <CardContent>
                <div className="border border-primary-borderSecondary rounded-lg overflow-hidden">
                  <Hero variant="split" title="Design with confidence" subtitle="Professional Tools" description="Access industry-leading design tools and templates. Create stunning visuals that captivate your audience." primaryAction={{
            ...
            href: "#",
            variant: "secondary",
        }} image="https://images.unsplash.com/photo-1558655146-d09347e92766?w=800&h=600&fit=crop" imageAlt="Design interface"/>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-8">
            ...
            <Card variant="elevated">
              ...
              <CardContent>
                <div className="border border-primary-borderSecondary rounded-lg overflow-hidden">
                  <Footer links={footerLinks} socialLinks={socialLinks} copyright="© 2024 Weave. All rights reserved."/>
                </div>
              </CardContent>
            </Card>
            ...
            <Card variant="elevated">
              ...
              <CardContent>
                <div className="border border-primary-borderSecondary rounded-lg overflow-hidden bg-primary-background">
                  <Footer variant="minimal" links={footerLinks.slice(0, 2)} socialLinks={socialLinks} copyright="© 2024 Weave. All rights reserved."/>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        {/* Buttons Section */}
        <section className="mb-16">
          <Typography variant="h2" size="2xl" weight="semibold" className="mb-8">
            Buttons
          </Typography>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card variant="elevated">
              ...
              <CardContent className="space-y-4">
                ...
                <Input placeholder="With helper text" helperText="This is helpful information"/>
              </CardContent>
            </Card>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card variant="elevated">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-4">
                  <Avatar size="md" src="https://github.com/shadcn.png" alt="User"/>
        ...
        <section className="mb-16">
          ...
          {/* Image Cards */}
          <div className="mt-8">
            <Typography variant="h3" size="xl" weight="semibold" className="mb-6">
              Image Cards
            </Typography>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card variant="elevated">
                <CardImage src="https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=400&h=200&fit=crop" alt="Nature"/>
                <CardHeader>
              ...
              <Card variant="elevated">
                <CardImage src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&h=200&fit=crop" alt="City"/>
                <CardHeader>
              ...
              <Card variant="elevated">
                <CardImage src="https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=400&h=200&fit=crop" alt="Forest"/>
                <CardHeader>
          ...
          <div className="mt-8">
            ...
            <Card variant="elevated">
              ...
              <CardContent>
                <Carousel className="w-full">
                  <CarouselItem>
                    <Image src="https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=800&h=400&fit=crop" alt="Nature" width={800} height={400} className="w-full h-64 object-cover rounded-lg"/>
                  </CarouselItem>
                  <CarouselItem>
                    <Image src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=400&fit=crop" alt="City" width={800} height={400} className="w-full h-64 object-cover rounded-lg"/>
                  </CarouselItem>
                  <CarouselItem>
                    <Image src="https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&h=400&fit=crop" alt="Forest" width={800} height={400} className="w-full h-64 object-cover rounded-lg"/>
                  </CarouselItem>
                </Carousel>
              </CardContent>
            </Card>
