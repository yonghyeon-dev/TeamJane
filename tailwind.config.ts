    ...
    extend: {
      colors: {
        ...
        primary: {
          ...
          DEFAULT: "var(--color-primary, #4ECDC4)",
          50: "#F0FDFC",
          100: "#CCFBF1",
          500: "#4ECDC4",
          600: "#45B7D1",
        ...
        status: {
          ...
          inProgress: "var(--color-status-in-progress, #4ECDC4)",
          feedback: "var(--color-status-feedback, #8B5CF6)",
          completed: "var(--color-status-completed, #10B981)",
          cancelled: "var(--color-status-cancelled, #EF4444)",
          onHold: "var(--color-status-on-hold, #6B7280)",
          
          // 문서 상태
          draft: "var(--color-status-draft, #6B7280)",
          sent: "var(--color-status-sent, #3B82F6)",
          viewed: "var(--color-status-viewed, #F59E0B)",
          signed: "var(--color-status-signed, #10B981)",
          
          // 청구서 상태
          issued: "var(--color-status-issued, #3B82F6)",
          paid: "var(--color-status-paid, #10B981)",
          overdue: "var(--color-status-overdue, #DC2626)",
        },
        // 재무 색상
        finance: {
          income: "var(--color-finance-income, #059669)",
          expense: "var(--color-finance-expense, #DC2626)",
          profit: "var(--color-finance-profit, #0D9488)",
          loss: "var(--color-finance-loss, #B91C1C)",
          tax: "var(--color-finance-tax, #7C3AED)",
        },
        // 우선순위 색상
        priority: {
          low: "var(--color-priority-low, #6B7280)",
          medium: "var(--color-priority-medium, #F59E0B)",
          high: "var(--color-priority-high, #EF4444)",
          urgent: "var(--color-priority-urgent, #DC2626)",
        },
        // 클라이언트 색상
        client: {
          active: "var(--color-client-active, #10B981)",
          inactive: "var(--color-client-inactive, #6B7280)",
          archived: "var(--color-client-archived, #374151)",
        },
